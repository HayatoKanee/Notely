...
SECRET_KEY = 'django-insecure-2qz1%n)38isr0ur4e1+26s8c28*tfweb##0hc$tct=p&p77j-*'
...
DEFAULT_FILE_STORAGE = 'notes.storage.CustomStorage'
...
if S3_ENABLED:
    ...
    DEFAULT_FILE_STORAGE = 'notes.storage.MediaStorage'
