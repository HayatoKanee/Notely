# Generated by Django 4.1.5 on 2023-03-17 16:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cred', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='events', to='notes.credential')),
            ],
            options={
                'permissions': [('dg_view_event', 'can view event'), ('dg_edit_event', 'can edit event'), ('dg_delete_event', 'can delete event')],
            },
        ),
        migrations.CreateModel(
            name='Folder',
            ...
            options={
                'permissions': [('dg_view_folder', 'can view folder'), ('dg_edit_folder', 'can edit folder'), ('dg_delete_folder', 'can delete folder'), ('dg_view_all_folder', 'can view all content in the folder'), ('dg_edit_all_folder', 'can edit all content in the folder')],
            },
        ),
        migrations.CreateModel(
            name='Notebook',
            ...
            options={
                'permissions': [('dg_view_notebook', 'can view notebook'), ('dg_edit_notebook', 'can edit notebook'), ('dg_delete_notebook', 'can delete notebook'), ('dg_view_all_notebook', 'can view all content in the notebook'), ('dg_edit_all_notebook', 'can view all content in the notebook')],
            },
        ),
        migrations.CreateModel(
            name='Page',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='templates', to='notes.page')),
            ],
        ),
        migrations.CreateModel(
            name='Reminder',
        ...
        migrations.AddField(
            model_name='event',
            name='pages',
            field=models.ManyToManyField(blank=True, related_name='events', to='notes.page'),
        ),
        migrations.AddField(
            model_name='event',
            name='user',
